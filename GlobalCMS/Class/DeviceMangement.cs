...
namespace HardwareHelperLib
{
    ...
    public class HH_Lib
    {
        readonly Version m_Version = new Version(1, 0, 0);
        ...
        public bool SetDeviceState(DEVICE_INFO deviceToChangeState, bool bEnable, string deviceName, string deviceFriendlyName, string deviceHardwareId, string deviceCOM, string deviceStatus)
        {
            Debug.WriteLine("bEnable: " + bEnable.ToString());
            Debug.WriteLine("DeviceName: " + deviceName.ToString());
            Debug.WriteLine("FriendlyName: " + deviceFriendlyName.ToString());
            Debug.WriteLine("HardwareID: " + deviceHardwareId.ToString());
            Debug.WriteLine("ComPort: " + deviceCOM.ToString());
            Debug.WriteLine("Status: " + deviceStatus.ToString());
            ...
            // StringBuilder DeviceHardwareId = new StringBuilder("");
            StringBuilder DeviceHardwareId = new StringBuilder(deviceHardwareId);

            // StringBuilder DeviceFriendlyName = new StringBuilder("");
            StringBuilder DeviceFriendlyName = new StringBuilder(deviceFriendlyName);
